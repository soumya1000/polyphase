...
//g++ -std=c++11 init.cpp -I/run/media/root/System/tbb44_20150728oss/include/
 //emalgo.o particlefilter.o sampling.o parsedata.o haplo.o globals.o -o init -lmpfr -L /run/media/root/System/tbb44_20150728oss/build/linux_intel64_gcc_cc4.8_libc2.19_kernel3.16.7_release/ -ltbb
...
//  double dThreshold = pow(10,-40);
 ...
 for (int i=48; i<num_deriv_vars; i++)
 {
